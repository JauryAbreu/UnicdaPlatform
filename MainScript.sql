...
INSERT INTO [dbo].[NcfType]
           ...
           ,[Deleted])
     VALUES
           (1,  0, 0, 'Credito Fiscal', 0),
           (2,  1, 0, 'Consumidor Final', 0),
           --(3,  0, 0, 'Nota de Debito', 0),
           (4,  1, 1, 'Nota de Credito', 0),
           (14,  0, 0, 'Regimen Especial', 0),
           (15,  0, 0, 'Gubernamental', 0)
END
GO
...
IF NOT EXISTS (SELECT
    *
  FROM AspNetUsers
  WHERE Id = 'aacb9e10-03a2-40cd-b1f3-f8bbc9429919')
BEGIN
	...
	VALUES ('aacb9e10-03a2-40cd-b1f3-f8bbc9429919','jaury.abreu@unicda.edu.do','JAURY.ABREU@UNICDA.EDU.DO','jaury.abreu@unicda.edu.do','JAURY.ABREU@UNICDA.EDU.DO',1,	
		  'AQAAAAEAACcQAAAAEEEhbVmmb0xRc6/djokAudPD0lPC4Xxj/+ijd9qsmkODfrFGSK0h0ZhgUStUiWGj4g==','ICQ4QAXPANQU3UL4JE3C6MU3DTXINEHY',
		  '4b938c3a-e8b8-497d-a803-f1421d33ad47','',0,0,'',1,0)
END
GO
...
IF NOT EXISTS (SELECT
    *
  FROM AspNetRoles
  WHERE Id = '0649371b-0d2d-4661-89c6-de59defa7d3a')
BEGIN
  INSERT INTO AspNetRoles ([Id]
  , [Name]
  , [NormalizedName]
  , [ConcurrencyStamp])
    VALUES ('0649371b-0d2d-4661-89c6-de59defa7d3a', 'General', 'GENERAL', '42ee6fd9-0012-4fbd-9df1-506375b9b2f5')
END

IF NOT EXISTS (SELECT
    *
  FROM AspNetUserRoles
  WHERE UserId = '68b92086-d478-4822-959a-716a13045d12' 
  AND RoleId = '0649371b-0d2d-4661-89c6-de59defa7d3a')
BEGIN

  INSERT INTO AspNetUserRoles ([UserId]
  , [RoleId])
    VALUES ('68b92086-d478-4822-959a-716a13045d12', '0649371b-0d2d-4661-89c6-de59defa7d3a')
END
GO
...
IF NOT EXISTS (SELECT
    *
  FROM [User]
  WHERE MasterId = 'aacb9e10-03a2-40cd-b1f3-f8bbc9429919')
BEGIN
  INSERT INTO [dbo].[User] (
      ...
      ,[Deleted],
	  [VatNumber])
    VALUES ('aacb9e10-03a2-40cd-b1f3-f8bbc9429919', 
	'774f0145-dd36-4063-9e30-be6f2b334c0c', 
	1,'2018-30-3-0028', 'Jaury', 'Abreu', 'Villa Mella',0, 'jaury.abreu@unicda.edu.do', '8092220000', 1, 4, 0, '')
END
GO
...
IF NOT EXISTS (SELECT * FROM [UserGroup])
BEGIN
SET IDENTITY_INSERT dbo.UserGroup ON;  
  INSERT INTO [dbo].[UserGroup] (
      ...
      ,[Name]
      ,[Deleted])
    VALUES	(1, 'f1aeab45-fc67-43b9-afcc-41e17915d2f3', '774f0145-dd36-4063-9e30-be6f2b334c0c', 'Administrador', 0),
			(2, 'bdd6810b-7b85-4fa1-a634-90017fa867b5', '774f0145-dd36-4063-9e30-be6f2b334c0c', 'Profesor', 0),
			(3, 'f1b04cef-c683-4a86-a105-5e232ae662f4', '774f0145-dd36-4063-9e30-be6f2b334c0c', 'Estudiantes', 0),
			(4, 'a474503e-6046-4951-92b8-27087a864d14', '774f0145-dd36-4063-9e30-be6f2b334c0c', 'Administrativos', 0),
			(5, '7ffdb068-01a9-4429-966e-6820bb64c6ea', '774f0145-dd36-4063-9e30-be6f2b334c0c', 'Cajero', 0),
			(6, '6eda3dd1-dbae-4420-9245-52d64d92937e', '774f0145-dd36-4063-9e30-be6f2b334c0c', 'Servicio al Cliente', 0)
...
BEGIN
  INSERT INTO [dbo].[Permission] (
      ...
      ,[Name]
      ,[Deleted])
    VALUES	( '290af560-fa2c-11da-974d-0800200c9a66', 'Inicio', 0),
			( 'e5971c50-554d-11db-b0de-0800200c9a66', 'Empresa', 0),
			( '2defc640-fa05-11da-974d-0800200c9a66', 'Socios', 0),
			( '3eb1f3a0-fac2-11da-974d-0800200c9a66', 'Clientes', 0),
			( '59188a60-b72f-11de-8a39-0800200c9a66', 'Modulo Fiscal', 0),
			( 'edf40550-ba3c-11de-8a39-0800200c9a66', 'Articulos', 0),
			( 'a330ca10-89af-11df-a4ee-0800200c9a66', 'Gastos', 0),
			( '71d5edaa-3743-43b3-9c8c-d3cb8d8fd708', 'Usuario', 0),
			( '9c29d3a0-09bd-11df-8a39-0800200c9a66', 'Perfil', 0),
			( 'c2417850-9643-11df-981c-0800200c9a66', 'Transacciones', 0),
			( '22e640f0-a6de-11df-981c-0800200c9a66', 'Cierre', 0),
			( '50bd6e9e-716f-4264-b8bc-cf790221e1d8', 'Reportes', 0),
			( 'c6d8aefa-fc52-4f43-8e86-a8976b957e58', 'Cuenta Bancaria', 0),
			( 'ce4dfce5-144f-4539-93d8-1894f34edbe6', 'Ingresos', 0)
END
GO



IF NOT EXISTS (SELECT * FROM [GroupPermission])
BEGIN
  INSERT INTO [dbo].[GroupPermission] (
      ...
      ,[Deleted])
			--Administrador
    VALUES	('f1aeab45-fc67-43b9-afcc-41e17915d2f3', '290af560-fa2c-11da-974d-0800200c9a66',  0), -- Inicio
			('f1aeab45-fc67-43b9-afcc-41e17915d2f3', 'e5971c50-554d-11db-b0de-0800200c9a66',  0), -- Empresa
			('f1aeab45-fc67-43b9-afcc-41e17915d2f3', '2defc640-fa05-11da-974d-0800200c9a66',  0), -- Socios
			('f1aeab45-fc67-43b9-afcc-41e17915d2f3', '3eb1f3a0-fac2-11da-974d-0800200c9a66',  0), -- Clientes
			('f1aeab45-fc67-43b9-afcc-41e17915d2f3', '59188a60-b72f-11de-8a39-0800200c9a66',  0), -- Modulo Fiscal
			('f1aeab45-fc67-43b9-afcc-41e17915d2f3', 'edf40550-ba3c-11de-8a39-0800200c9a66',  0), -- Articulos
			('f1aeab45-fc67-43b9-afcc-41e17915d2f3', 'a330ca10-89af-11df-a4ee-0800200c9a66',  0), -- Gastos
			('f1aeab45-fc67-43b9-afcc-41e17915d2f3', '71d5edaa-3743-43b3-9c8c-d3cb8d8fd708',  0), -- Usuario
			('f1aeab45-fc67-43b9-afcc-41e17915d2f3', '9c29d3a0-09bd-11df-8a39-0800200c9a66',  0), -- Perfil
			('f1aeab45-fc67-43b9-afcc-41e17915d2f3', 'c2417850-9643-11df-981c-0800200c9a66',  0), -- Transacciones
			('f1aeab45-fc67-43b9-afcc-41e17915d2f3', '22e640f0-a6de-11df-981c-0800200c9a66',  0), -- Cierre
			('f1aeab45-fc67-43b9-afcc-41e17915d2f3', '50bd6e9e-716f-4264-b8bc-cf790221e1d8',  0),  -- Reportes
			('f1aeab45-fc67-43b9-afcc-41e17915d2f3', 'c6d8aefa-fc52-4f43-8e86-a8976b957e58',  0),  -- Reportes

			--Reportes
			('bdd6810b-7b85-4fa1-a634-90017fa867b5', '290af560-fa2c-11da-974d-0800200c9a66',  0), -- Inicio
			('bdd6810b-7b85-4fa1-a634-90017fa867b5', '22e640f0-a6de-11df-981c-0800200c9a66',  0), -- Cierre
			('bdd6810b-7b85-4fa1-a634-90017fa867b5', '9c29d3a0-09bd-11df-8a39-0800200c9a66',  0), -- Perfil
			('bdd6810b-7b85-4fa1-a634-90017fa867b5', '50bd6e9e-716f-4264-b8bc-cf790221e1d8',  0),  -- Reportes

			--Articulos
			( 'f1b04cef-c683-4a86-a105-5e232ae662f4', 'edf40550-ba3c-11de-8a39-0800200c9a66',  0), -- Articulos
			( 'f1b04cef-c683-4a86-a105-5e232ae662f4', '22e640f0-a6de-11df-981c-0800200c9a66',  0), -- Cierre


			--Basico
			('a474503e-6046-4951-92b8-27087a864d14', '2defc640-fa05-11da-974d-0800200c9a66',  0), -- Socios
			('a474503e-6046-4951-92b8-27087a864d14', '3eb1f3a0-fac2-11da-974d-0800200c9a66',  0), -- Clientes
			('a474503e-6046-4951-92b8-27087a864d14', 'edf40550-ba3c-11de-8a39-0800200c9a66',  0), -- Articulos
			('a474503e-6046-4951-92b8-27087a864d14', 'a330ca10-89af-11df-a4ee-0800200c9a66',  0), -- Gastos
			('a474503e-6046-4951-92b8-27087a864d14', '9c29d3a0-09bd-11df-8a39-0800200c9a66',  0), -- Perfil


			--Cajero
			('7ffdb068-01a9-4429-966e-6820bb64c6ea', '2defc640-fa05-11da-974d-0800200c9a66',  0), -- Socios
			('7ffdb068-01a9-4429-966e-6820bb64c6ea', '3eb1f3a0-fac2-11da-974d-0800200c9a66',  0), -- Clientes
			('7ffdb068-01a9-4429-966e-6820bb64c6ea', 'edf40550-ba3c-11de-8a39-0800200c9a66',  0), -- Articulos
			('7ffdb068-01a9-4429-966e-6820bb64c6ea', '9c29d3a0-09bd-11df-8a39-0800200c9a66',  0), -- Perfil
			('7ffdb068-01a9-4429-966e-6820bb64c6ea', 'c2417850-9643-11df-981c-0800200c9a66',  0), -- Transacciones
			('7ffdb068-01a9-4429-966e-6820bb64c6ea', '22e640f0-a6de-11df-981c-0800200c9a66',  0), -- Cierre


			--Cajero Avazando
			('6eda3dd1-dbae-4420-9245-52d64d92937e', '2defc640-fa05-11da-974d-0800200c9a66',  0), -- Socios
			('6eda3dd1-dbae-4420-9245-52d64d92937e', '3eb1f3a0-fac2-11da-974d-0800200c9a66',  0), -- Clientes
			('6eda3dd1-dbae-4420-9245-52d64d92937e', '59188a60-b72f-11de-8a39-0800200c9a66',  0), -- Modulo Fiscal
			('6eda3dd1-dbae-4420-9245-52d64d92937e', 'edf40550-ba3c-11de-8a39-0800200c9a66',  0), -- Articulos
			('6eda3dd1-dbae-4420-9245-52d64d92937e', 'a330ca10-89af-11df-a4ee-0800200c9a66',  0), -- Gastos
			('6eda3dd1-dbae-4420-9245-52d64d92937e', '9c29d3a0-09bd-11df-8a39-0800200c9a66',  0), -- Perfil
			('6eda3dd1-dbae-4420-9245-52d64d92937e', 'c2417850-9643-11df-981c-0800200c9a66',  0), -- Transacciones
			('6eda3dd1-dbae-4420-9245-52d64d92937e', '22e640f0-a6de-11df-981c-0800200c9a66',  0)  -- Cierre
END
GO
...
INSERT INTO [dbo].[Company]
		   ...
		   [VatNumber],[State], [Country], 
		   [Address],[Email], 
		   [Phone], [Logo]
           ,[Currency], [License], [ReceiptId]
           ,[Deleted], [DGIITax],[EmailSMTP], [PasswordSMTP])
     VALUES
           ('774f0145-dd36-4063-9e30-be6f2b334c0c','Dominico Americano','INSTITUTO CULTURAL DOMINICO- AMERICANO',
		   '401004178',0,0
           ,'Av. Abraham Lincoln #21 Santo Domingo','comunicaciones@icda.edu.do'
           ,'8095350665','~/Companies/774f0145-dd36-4063-9e30-be6f2b334c0c.png',
		   57.2,'',1,
		   0, 18, 'naturallife1010@gmail.com','123P@$$w0rd45')
END
GO
...
BEGIN
  ...
  INSERT INTO [Country] ([Id], [SortCode], [Description], [PhoneCode])
    VALUES
    (1, 'DO', 'Republica Dominicana', 1809),
    (2, 'AL', 'Albania', 355),
    (3, 'DZ', 'Algeria', 213),
...
SET IDENTITY_INSERT dbo.[State] ON; 
  INSERT INTO [State] (Id, [Description], [CountryId])
    ...
    (991, 'La Romana', 1),
    (992, 'La Vega', 1),
    (993, 'Maria Trinidad Sanchez', 1),
    (994, 'Monsenor Nouel', 1),
    (995, 'Monte Cristi', 1),
    (996, 'Monte Plata', 1),
    (997, 'Pedernales', 1),
    (998, 'Peravia', 1),
    ...
    (1000, 'Salcedo', 1);
  INSERT INTO State (Id, [Description], [CountryId])
    VALUES (1001, 'Samana', 1),
    (1002, 'San Cristobal', 1),
    (1003, 'San Juan', 1),
    (1004, 'San Pedro de Macoris', 1),
    (1005, 'Sanchez Ramirez', 1),
    (1006, 'Santiago', 1),
    (1007, 'Santiago Rodriguez', 1),
    (1008, 'Valverde', 1),
    (1009, 'Aileu', 62),
    (1010, 'Ainaro', 62),
    (1011, 'Ambeno', 62),
    ...
    (2000, 'Pavlodar', 112);
  INSERT INTO State (Id, [Description], [CountryId])
    VALUES (2001, 'Sigis Kazakstan', 112),
  ...
  INSERT INTO State (Id, [Description], [CountryId])
    ...
    (4000, 'Buhoro', 234);
  INSERT INTO State (Id, [Description], [CountryId])
    VALUES (4001, 'Buxoro Viloyati', 234),
    (4002, 'Cizah', 234),
    (4003, 'Fargona', 234),
    (4004, 'Horazm', 234),
    (4005, 'Kaskadar', 234),
...
INSERT INTO ItemDepartment (ID, [Name], Deleted)
VALUES (1,'Abarth',0),
(2,'Alfa Romeo',0),
(3,'Aro',0),
(4,'Asia',0),
...
INSERT INTO ItemGroup (DepartmentId, [Name], Deleted)
VALUES (1,'500',0),
(1,'Grande Punto',0),
(1,'Punto Evo',0),
(1,'500c',0),
...
(10,'Arnage',0),
(10,'Continental Gt',0),
(10,'Continental Flying Spur',0),
(10,'Turbo R',0),
(10,'Mulsanne',0),
(10,'Eight',0),
(10,'Continental Gtc',0),
(10,'Continental Supersports',0),
(11,'Freeclimber Diesel',0),
(12,'Serie 3',0),
(12,'Serie 5',0),
(12,'Compact',0),
(12,'Serie 7',0),
...
(42,'Prisma',0),
(42,'A112',0),
(42,'Ypsilon Elefantino',0),
(42,'Voyager',0),
(43,'Range Rover',0),
(43,'Defender',0),
(43,'Discovery',0),
(43,'Freelander',0),
(43,'Range Rover Sport',0),
(43,'Discovery 4',0),
(43,'Range Rover Evoque',0),
(44,'Maxus',0),
(45,'Ls400',0),
(45,'Ls430',0),
(45,'Gs300',0),
...
(74,'Supra',0),
(74,'Paseo',0),
(74,'Land Cruiser 80',0),
(74,'Land Cruiser 100',0),
(74,'Land Cruiser',0),
(74,'Land Cruiser 90',0),
(74,'Corolla',0),
(74,'Auris',0),
(74,'Avensis',0),
(74,'Picnic',0),
...
IF EXISTS (
        ...
        WHERE NAME = 'usp_GenerateSequenceNumber'
            AND type = 'P'
      )
     DROP PROCEDURE dbo.usp_GenerateSequenceNumber
GO
CREATE PROCEDURE [dbo].[usp_GenerateSequenceNumber]
@_COMPANYID		NVARCHAR(36),
@_NCFID			TINYINT = 2,
@_PROCESS		TINYINT = 2
AS
BEGIN
DECLARE @COMPANYID		NVARCHAR(36) = @_COMPANYID;
DECLARE @NCFID			TINYINT = @_NCFID;
DECLARE @PROCESS		TINYINT = @_PROCESS;
DECLARE @NCF			NVARCHAR(11) = '';
	...
	BEGIN
		BEGIN TRAN
			...
			UPDATE NcfSequenceDetail 
				SET SEQNEXT = SEQNEXT + 1  
					OUTPUT deleted.SEQNEXT,
							deleted.SERIE   
						INTO @MyTableVar
							WHERE COMPANYID = @COMPANYID AND NCFID = @NCFID AND
									DATESTART <= GETDATE() AND DATEEND >= GETDATE() AND
									SEQSTATUS = 1 AND DELETED = 0

			SELECT CAST(serie + REPLACE(STR(@_NCFID, 2), SPACE(1), '0')  + 
					  REPLACE(STR(sequence, 8), SPACE(1), '0') AS NVARCHAR(11)) AS DGIIDescription,
					  0 AS [Id], '' AS [MasterId], '' AS [CompanyId],
					  1 AS [NcfId], 'B' AS [Serie] , 1 AS[SeqStart], 1 AS [SeqEnd],
					  1 AS [SeqNext], GETDATE() AS [DateStart], GETDATE() AS [DateEnd],
					  1 AS [SeqStatus], CAST(0 AS BIT) AS [Deleted]
				FROM @MyTableVar;
	...
	ELSE IF(@PROCESS = 1)
	BEGIN
		IF EXISTS(SELECT 1 FROM NcfSequenceDetail WHERE COMPANYID = @COMPANYID AND NCFID = @NCFID AND	DATESTART <= GETDATE() AND 
								DATEEND >= GETDATE() AND SEQSTART <= SEQNEXT AND  SEQSTATUS = 1 AND DELETED = 0)
		BEGIN
			SELECT TOP(1) MASTERID, COMPANYID, NCFID, SERIE, SEQSTART,
					ISNULL((SELECT SUM(SEQEND)	FROM NcfSequenceDetail WHERE COMPANYID = @COMPANYID AND NCFID = @NCFID AND DATESTART <= GETDATE() AND DATEEND >= GETDATE() AND
											SEQSTATUS IN (0,1) AND SEQSTART <= SEQNEXT AND SEQEND >= SEQNEXT AND DELETED = 0),0) AS SEQEND, 
					ISNULL((SELECT SUM(SEQNEXT)	FROM NcfSequenceDetail WHERE COMPANYID = @COMPANYID AND NCFID = @NCFID AND DATESTART <= GETDATE() AND DATEEND >= GETDATE() AND
											SEQSTATUS IN (0,1) AND SEQSTART <= SEQNEXT AND SEQEND >= SEQNEXT AND DELETED = 0),0) AS SEQNEXT, 
					DATESTART,
					DATEEND, SEQSTATUS, DELETED, ISNULL((SELECT n.[Description] FROM NcfType n WHERE n.NcfId = s.NcfId), '') DGIIDESCRIPTION, ID
					FROM NcfSequenceDetail s
						WHERE COMPANYID = @COMPANYID AND NCFID = @NCFID AND 
								DATESTART <= GETDATE() AND DATEEND >= GETDATE() AND
								SEQSTATUS = 1 AND SEQSTART <= SEQNEXT AND 
								SEQEND >= SEQNEXT AND DELETED = 0
									ORDER BY DATESTART ASC

									
		END
		ELSE
		SELECT TOP(1) CAST(MASTERID AS varchar(36)) AS MASTERID,COMPANYID,NCFID,ID,SERIE
					 ,SEQSTART,SEQEND,SEQNEXT,DATESTART,DATEEND
					 ,DGIIDESCRIPTION,SEQSTATUS,DELETED, ID
				FROM NcfSequenceDetail s
						WHERE COMPANYID = @COMPANYID AND NCFID = @NCFID AND
								SEQSTATUS IN (2,3) AND DELETED = 0
...
IF EXISTS (
        SELECT type_desc, type
        FROM sys.procedures WITH(NOLOCK)
        WHERE NAME = 'usp_ApplyNCFToUse'
            AND type = 'P'
      )
     DROP PROCEDURE dbo.usp_ApplyNCFToUse
GO

CREATE PROCEDURE [dbo].[usp_ApplyNCFToUse]
@_COMPANYID		NVARCHAR(36),
@_NCFID			TINYINT = 2,
@_PROCESS		BIT = 0
AS
	DECLARE @COMPANYID		NVARCHAR(36) = @_COMPANYID;
	DECLARE @NCFID			TINYINT = @_NCFID;
	DECLARE @PROCESS		BIT = @_PROCESS;
	DECLARE @VALIDATE		BIT = 0;
	DECLARE @GUID			UNIQUEIDENTIFIER;
	DECLARE @ID				NVARCHAR(36) = '';
BEGIN
	--SET NOCOUNT OFF; 
	UPDATE NcfSequenceDetail SET SEQSTATUS = 2 WHERE NCFID = @NCFID AND SEQEND < SEQNEXT   AND SEQSTATUS NOT IN (2,3)
	UPDATE NcfSequenceDetail SET SEQSTATUS = 3 WHERE NCFID = @NCFID AND DATEEND < GETDATE() AND SEQSTATUS NOT IN (2,3)
	--SET NOCOUNT ON; 
	
	SELECT @VALIDATE = (SELECT CAST(COUNT(*) AS BIT) AS RETORNO 
							FROM NcfSequenceDetail 
								WHERE COMPANYID = @COMPANYID AND NCFID = @NCFID AND
									  DATESTART <= GETDATE() AND DATEEND >= GETDATE() AND
									  SEQSTART <= SEQNEXT AND SEQEND >= SEQNEXT AND
									  SEQSTATUS = 1 AND DELETED = 0);
	IF(@VALIDATE = 0)
	BEGIN 
		SELECT @GUID = (SELECT TOP(1) MASTERID 
							FROM NcfSequenceDetail 
								WHERE COMPANYID = @COMPANYID AND NCFID = @NCFID AND 
									  DATESTART <= GETDATE() AND DATEEND >= GETDATE() AND
									  SEQSTATUS = 0 AND SEQSTART <= SEQNEXT AND 
									  SEQEND >= SEQNEXT AND DELETED = 0 
									  ORDER BY DATESTART, ID ASC)
		SELECT @ID = CAST(@GUID AS NVARCHAR(36));
		IF(@ID <> '')
		BEGIN
			UPDATE NcfSequenceDetail SET SEQSTATUS = 1 WHERE MASTERID = @GUID;
			UPDATE NcfSequenceDetail SET SEQSTATUS = 0 WHERE NCFID = @NCFID AND SEQSTATUS NOT IN (2,3) AND MASTERID <> @GUID;
			
			UPDATE NcfSequenceDetail 
				SET SEQSTATUS = 0 
					WHERE MASTERID <> @GUID AND COMPANYID = @COMPANYID AND 
						  NCFID = @NCFID AND SEQSTATUS IN (0,1) AND DELETED = 0 ;
			
			IF(@PROCESS = 0)
			BEGIN
				EXECUTE usp_GenerateSequenceNumber @COMPANYID, @NCFID, 1
			END
			ELSE IF(@PROCESS = 1)
			BEGIN
				EXECUTE usp_GenerateSequenceNumber @COMPANYID, @NCFID, 0
			END
		END
		ELSE
			EXECUTE usp_GenerateSequenceNumber @COMPANYID, @NCFID, 2

	END 
	ELSE IF(@VALIDATE = 1 AND @PROCESS = 0)
	BEGIN
		EXECUTE usp_GenerateSequenceNumber @COMPANYID, @NCFID, 1
	END
	ELSE IF (@VALIDATE = 1 AND @PROCESS = 1)
	BEGIN
		EXECUTE usp_GenerateSequenceNumber @COMPANYID, @NCFID, 0
	END
END
